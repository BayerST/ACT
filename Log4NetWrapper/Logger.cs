...
namespace de.pta.Component.Logging.Log4NetWrapper
{
	...
	public class Logger
	{
        ...
        /// <summary>
        /// Initialises logger and sets config path
        /// </summary>
		private void InitializeLogger()
		{
            //This is root path of ASP .net application
            string log4netConfig = HttpRuntime.AppDomainAppPath;

            DOMConfigurator.Configure(new FileInfo(log4netConfig + LOG4NET_CONFIGURATION));          
		}
